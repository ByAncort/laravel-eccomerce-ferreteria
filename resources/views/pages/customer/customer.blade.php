    ...
    <div class="bg-gray-50 dark:bg-gray-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 lg:py-12">
            ...
            <div class="mb-6 sm:mb-8">
                <h1 class="font-serif text-3xl sm:text-4xl text-gray-900 dark:text-white">Clientes</h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-6 lg:gap-8 items-start">
                ...
                <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl sticky top-6">
                    <div class="p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700">
                        <h2 class="font-serif text-xl text-gray-900 dark:text-white">Nuevo Cliente</h2>
                    </div>
                    ...
                    <form action="{{ route('customers.store') }}" method="POST" class="p-4 sm:p-6 space-y-4">
                        ...
                        <button type="submit" 
                                class="w-full mt-2 px-4 py-2.5 bg-gray-900 dark:bg-gray-700 hover:bg-gray-800 dark:hover:bg-gray-600 text-white text-sm font-semibold rounded-lg transition active:scale-[0.99]">
                            Guardar Cliente
                        </button>
                    </form>
                </div>
